...
<p>You are currently accessing CAS over a non-secure connection.  Single Sign on WILL NOT WORK.  In order to have single sign on work, you MUST log in over HTTPS.</p>
			...
			<form:form method="post" id="fm1" action="${formActionUrl}" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row fl-controls-left">
                        <a href="<c:url value="login"/>?execution=${flowExecutionKey}&_eventId=forgotPassword"><spring:message code="screen.welcome.link.forgotPassward" /></a>
                    </div>
                    <div class="row check">
